    ...
    <footer className="footer" id="Contact">
      <section className="container">
        ...
        <div className="flex-container">
          <img className="profile-pic" src="Images/myPic.png" alt="My Picture" />
        ...
        <div>
          <small className="help-text">Don't know if it fits your needs or not? <Link className="help-link" href="#">Let me help!</Link></small>
        </div>
      </section>
    </footer>
    </div>
